...
public class Prueba 
{
    ...
    public static void main(String []args)
    {
        ...
        System.out.println("");
        portada.setNombrePeriodico("UTOPIA");
        ...
        System.out.println("");
        notice.setAutor("Dennis Rivadeneira");
        notice.setTitulo("Mundial de Futbol");
        notice.setContenido("Aqui va todo el contenido de la noticia ");
